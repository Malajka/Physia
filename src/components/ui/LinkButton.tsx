...
const variantStyles: Record<"primary" | "secondary" | "text" | "nav-link" | "nav-primary" | "nav-secondary" | "nav-muted", string> = {
  ...
  "nav-primary":
    "px-2 py-2 bg-[var(--primary)] border border-[var(--primary)] text-[var(--primary-foreground)] font-bold text-lg rounded-xl shadow-md text-center hover:opacity-80",
  "nav-secondary":
    "bg-[var(--card)] border border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--light-green)] font-bold text-lg rounded-xl shadow-md text-center hover:opacity-80",
