...
import { getMuscleTestImage } from "@/lib/services/exercises/helpers";
  ...
  return (
    <div className="p-6 border drop-shadow-md rounded-lg bg-white">
      ...
      {warnings.length > 0 && (
        <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-r">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h4 className="text-s font-medium text-red-800 uppercase tracking-wide mb-1">Important</h4>
              <div className="text-s text-red-700 ">
      ...
      {info.length > 0 && (
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h4 className="text-s font-medium text-blue-800 uppercase tracking-wide mb-1">What to expect</h4>
      ...
      {notes.length > 0 && (
        <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h4 className="text-s font-medium text-amber-800 uppercase tracking-wide mb-1">Remember</h4>
              <div className="text-s text-amber-700 ">
      ...
      <div className="flex flex-col space-y-6 mt-6">
        <label htmlFor={`pain-${test.id}`} className="font-bold text-xl">
          Pain level:{" "}
          <span
            style={{
