...
import "kleur/colors";
import { $ as $$Layout } from "../chunks/Layout_BWdJMhQf.mjs";
...
Train smarter, recover faster, and feel better with routines designed just for you. Take control of your health and start seeing real
          ...
          !isAuthenticated
            ? renderTemplate`<div class="flex flex-col sm:flex-row gap-4 justify-center items-center"> <a href="/login" class="w-fit max-w-36 sm:max-w-none sm:px-8 px-5 py-3 bg-[var(--primary)] hover:bg-dark-green text-[var(--primary-foreground)] font-medium rounded-xl shadow-md transition-colors">
Log In
...
Create Account
            ...
            : null
        } </section> <section class="grid md:grid-cols-3 gap-6 mb-20" id="services"> <div class="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.12)] transition-all duration-300 transform hover:-translate-y-1"> <div class="flex items-center mb-4"> <div class="w-12 h-12 bg-gradient-to-br from-[#1ea39a] to-[#16857f] rounded-xl flex items-center justify-center text-white text-xl font-bold mr-4">
1
