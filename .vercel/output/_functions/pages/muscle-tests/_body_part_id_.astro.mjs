...
import "kleur/colors";
import { v as validateBodyPartId, f as fetchMuscleTestsAndBodyPartName, $ as $$PageHeader } from "../../chunks/PageHeader_RbsskymR.mjs";
import { jsxs, jsx } from "react/jsx-runtime";
import { b as Slider, B as Button, $ as $$Layout, E as ErrorAlert } from "../../chunks/Layout_BWdJMhQf.mjs";
...
function getPageTitle(bodyPartName, bodyPartId) {
  return bodyPartName ? `Muscle Tests for ${bodyPartName}` : `Muscle Tests for Body Part ${bodyPartId}`;
}

async function getMuscleTestsPageData({ params, request }) {
