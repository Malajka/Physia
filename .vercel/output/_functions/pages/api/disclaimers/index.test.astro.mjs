...
import { G as GET, P as POST } from "../../../chunks/index_Bj24hUCM.mjs";
export { renderers } from "../../../renderers.mjs";

const mockNext = vi.fn().mockResolvedValue(new Response("ok"));
function createMockSession(userMetadata = {}) {
  return {
...
function makeContext({ pathname = "/sessions/1", session = null, sessionOwner = true, cookies = {} } = {}) {
...
describe("/api/disclaimers POST", () => {
  ...
  it("returns 201 and accepted_at on success", async () => {
    vi.useFakeTimers();
    const now = /* @__PURE__ */ new Date("2024-05-25T12:00:00.000Z");
