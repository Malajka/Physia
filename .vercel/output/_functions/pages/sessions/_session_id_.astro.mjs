...
import { B as Button, $ as $$Layout } from "../../chunks/Layout_BWdJMhQf.mjs";
    ...
    children: [
      ...
      feedback?.rated_at &&
        /* @__PURE__ */ jsxs("p", {
          ...
          children: ["Rated at: ", new Date(feedback.rated_at).toLocaleString()],
        }),
    ],
  });
};
...
function TrainingPlanDisplay({ trainingPlan, exerciseImagesMap }) {
  ...
  const SectionCard = ({ title, sectionData, bgColor = "bg-white", accentColor = "blue" }) =>
    /* @__PURE__ */ jsxs("div", {
      className: `${bgColor} rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.08)] min-h-[400px]`,
      children: [
        ...
        sectionData.length > 0
          ? /* @__PURE__ */ jsx("div", {
              className: "space-y-4",
              children: sectionData.map(({ exercise, content }, index) =>
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          /* @__PURE__ */ jsxs("span", {
                            className: "bg-[var(--primary)] text-white px-2 py-1 rounded-md",
                            children: [exercise.sets, " sets"],
                          }),
                          /* @__PURE__ */ jsxs("span", {
                            className: "bg-[var(--primary)] text-white px-2 py-1 rounded-md",
                          ...
                          /* @__PURE__ */ jsxs("span", {
                            ...
                            children: [exercise.rest_time_seconds, "s rest"],
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsx("div", {
                      ...
                      exercise.notes &&
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx("p", { className: "text-sm text-amber-800 italic", children: exercise.notes }),
                        }),
                      exerciseImagesMap[exercise.id]?.length > 0 &&
                        /* @__PURE__ */ jsx("div", {
                          ...
                          children: /* @__PURE__ */ jsx("div", {
                            ...
                            children: exerciseImagesMap[exercise.id].map((img, imgIndex) =>
                              /* @__PURE__ */ jsx(
                                "img",
                                {
                                  src: img.file_path,
          ...
          : /* @__PURE__ */ jsx("div", {
              ...
              children: /* @__PURE__ */ jsx("p", { children: "No exercises for this section" }),
            }),
      ],
    });
  return /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx("h2", {
            ...
            children: trainingPlan.title,
          }),
          /* @__PURE__ */ jsx("p", {
            "data-testid": "session-description",
            className: "text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed",
            children: trainingPlan.description,
          }),
        ],
      }),
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("ul", {
                    ...
                    children: trainingPlan.warnings.map((warning, index) =>
                      /* @__PURE__ */ jsxs(
                        "li",
                        {
                          className: "flex items-start",
                          children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-red-400 rounded-full mt-2 mr-2 flex-shrink-0" }), warning],
                        },
                        index
                      )
                    ),
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsx(SectionCard, {
            title: "Warm-Up",
            sectionData: allSections.warmup,
            bgColor: "bg-gradient-to-br from-orange-50 to-orange-100",
            accentColor: "orange",
          }),
          /* @__PURE__ */ jsx(SectionCard, {
            title: "Workout",
            sectionData: allSections.workout,
...
const $$sessionId = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    const authRes = await Astro2.locals.supabase.auth.getSession();
    const session = authRes.data.session;
    if (!session) {
      return Astro2.redirect("/login");
    }
    if (!session.user.user_metadata?.disclaimer_accepted_at) {
      return Astro2.redirect("/body-parts");
    }
    ...
    if (fetchError || !sessionRow) {
      return Astro2.redirect("/sessions");
    }
    ...
    if (trainingSession) {
      ...
      if (!exercisesError && exercisesData) {
        exerciseImagesMap = exercisesData.reduce((acc, item) => {
