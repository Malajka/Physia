...
import {
  C as decryptString,
  G as createSlotValueFromString,
  H as isAstroComponentFactory,
  r as renderComponent,
  b as renderTemplate,
  v as REROUTE_DIRECTIVE_HEADER,
  A as AstroError,
  J as i18nNoLocaleFoundInPath,
  K as ResponseSentError,
  O as originPathnameSymbol,
  P as RewriteWithBodyUsed,
  Q as MiddlewareNoDataOrNextCalled,
  S as MiddlewareNotAResponse,
  T as GetStaticPathsRequired,
  ...
  _ as NoMatchingStaticPathFound,
  $ as PrerenderDynamicEndpointPathCollide,
  a0 as ReservedSlotName,
  a1 as renderSlotToString,
  a2 as renderJSX,
  a3 as chunkToString,
  a4 as isRenderInstruction,
  a5 as SessionStorageSaveError,
  a6 as SessionStorageInitError,
  u as ROUTE_TYPE_HEADER,
  a7 as ForbiddenRewrite,
  a8 as ASTRO_VERSION,
  a9 as LocalsReassigned,
...
import {
  ...
  a as deserializeActionResult,
  D as DEFAULT_404_ROUTE,
  A as ActionError,
  s as serializeActionResult,
  b as ACTION_RPC_ROUTE_PATTERN,
  c as ACTION_QUERY_PARAMS,
} from "./astro-designed-error-pages_Cv7EM1T7.mjs";
  ...
  if (callerInfo && context.request.method === "POST" && !actionResultAlreadySet) {
    action = {
      ...
      handler: async () => {
        ...
        const { props: _props, getActionResult: _getActionResult, callAction: _callAction, redirect: _redirect, ...actionAPIContext } = context;
...
function getParams(route, pathname) {
  ...
  const paramsMatch =
    route.pattern.exec(pathname) || route.fallbackRoutes.map((fallbackRoute) => fallbackRoute.pattern.exec(pathname)).find((x) => x);
