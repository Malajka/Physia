import {
  ...
  g as renderHead,
  h as renderSlot,
} from "./astro/server_CfAXeihZ.mjs";
import "kleur/colors";
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            className: "ml-3",
            children: [
              /* @__PURE__ */ jsxs("h3", { className: "text-sm font-medium text-red-800", children: ["Error", list.length > 1 ? "s" : ""] }),
              /* @__PURE__ */ jsx("div", {
                className: "mt-2 text-sm",
                children: /* @__PURE__ */ jsx("ul", {
                  className: "list-disc pl-5 space-y-1",
                  children: list.map((err, i) =>
                    /* @__PURE__ */ jsx(
                      "li",
                      {
                        children: render
                          ? render(err)
                          : typeof err === "string"
                            ? /* @__PURE__ */ jsx("span", { dangerouslySetInnerHTML: { __html: err } })
                            : err,
                      },
                      i
                    )
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs("label", {
        ...
        children: [label, required && /* @__PURE__ */ jsx("span", { className: "text-red-500 ml-1", "aria-hidden": "true", children: "*" })],
      }),
      /* @__PURE__ */ jsx("input", {
        id,
        name: name || id,
...
const LinkButton = React__default.memo(function LinkButton2({ href, children, variant = "primary", className = "", "data-testid": dataTestId }) {
      ...
      /* @__PURE__ */ jsxs(SliderPrimitive.Root, {
        ...
        children: [
          /* @__PURE__ */ jsx(SliderPrimitive.Track, {
            ...
            children: /* @__PURE__ */ jsx(SliderPrimitive.Range, { className: "slider-range" }),
          }),
...
function Spinner({ className, ...props }) {
  return /* @__PURE__ */ jsx("div", {
    className: cn("animate-spin rounded-full border-4 border-t-transparent border-primary h-8 w-8", className),
    ...props,
  });
}
...
const LogoutButton = function LogoutButton2({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxs(Button, {
    ...
    children: [isLoggingOut ? /* @__PURE__ */ jsx(Spinner, { className: "h-4 w-4" }) : null, isLoggingOut ? "Logging out..." : "Log out"],
  });
};
  ...
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<nav class="flex items-center w-full z-[9]" role="navigation" aria-label="Main navigation"> <!-- Desktop Navigation --> <ul class="hidden lg:flex flex-1 justify-center items-center space-x-6" role="menubar"> ${NAVIGATION_SECTIONS.map((section) => renderTemplate`<li> ${renderComponent($$result, "LinkButton", LinkButton, { href: `/#${section}`, variant: "nav-link" }, { default: ($$result2) => renderTemplate`${capitalizeFirst(section)}` })} </li>`)} </ul> <!-- Mobile Navigation --> <details class="lg:hidden ml-auto relative" role="group"> <summary class="list-none p-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--primary)] rounded-lg" aria-label="Toggle navigation menu" role="button" tabindex="0"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[var(--primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"></path> </svg> </summary> <ul class="absolute right-0 mt-2 w-48 bg-[var(--card)] p-4 shadow-md space-y-2 text-right border border-[var(--border)]" role="menu"> ${NAVIGATION_SECTIONS.map((section) => renderTemplate`<li> ${renderComponent($$result, "LinkButton", LinkButton, { href: `/#${section}`, variant: "nav-link", className: "block" }, { default: ($$result2) => renderTemplate`${capitalizeFirst(section)}` })} </li>`)} ${
      ...
      renderTemplate`${renderComponent(
        ...
        {
          default: ($$result2) =>
            renderTemplate` <li> ${renderComponent(
              $$result2,
              "LinkButton",
              LinkButton,
              { href: "/login", variant: "nav-primary", className: "block w-full" },
              {
                default: ($$result3) => renderTemplate`
Log in
`,
              }
            )} </li> <li> ${renderComponent(
              $$result2,
              "LinkButton",
              LinkButton,
              { href: "/register", variant: "nav-secondary", className: "block w-full" },
              {
                default: ($$result3) => renderTemplate`
Register
`,
        ...
        {},
        {
          default: ($$result2) =>
            renderTemplate` <li> ${renderComponent(
              ...
              "LinkButton",
              LinkButton,
              { href: "/sessions", variant: "nav-link", className: "block" },
              {
                default: ($$result3) => renderTemplate`
My Sessions
`,
              ...
              "LinkButton",
              LinkButton,
              { href: "/body-parts", variant: "nav-link", className: "block", "data-testid": "create-new-session-mobile" },
              {
                default: ($$result3) => renderTemplate`
Create New Session
`,
              }
            )} </li> <li> ${renderComponent($$result2, "LogoutButton", LogoutButton, { "client:load": true, className: "block w-full bg-transparent border border-[var(--gray-text)] text-[var(--gray-text)] hover:bg-[var(--light-green)] font-bold px-6 rounded-xl transition-colors", "client:component-hydration": "load", "client:component-path": "@/components/auth/LogoutButton", "client:component-export": "LogoutButton" })} </li> `,
        }
      )}`
    } </ul> </details> <!-- Desktop Auth/User Buttons --> <ul class="hidden lg:flex items-center space-x-6"> ${
      showAuthButtons &&
      renderTemplate`${renderComponent(
        $$result,
        "Fragment",
        ...
        {},
        {
          default: ($$result2) =>
            renderTemplate` <li> ${renderComponent(
              ...
              "LinkButton",
              LinkButton,
              { href: "/login", variant: "nav-primary" },
              {
                default: ($$result3) => renderTemplate`
Log in
`,
              ...
              "LinkButton",
              LinkButton,
              { href: "/register", variant: "nav-secondary" },
              {
                default: ($$result3) => renderTemplate`
Register
`,
...
`,
              ...
              "LinkButton",
              LinkButton,
              { href: "/body-parts", variant: "nav-link", className: "block", "data-testid": "create-new-session-desktop" },
              {
                default: ($$result3) => renderTemplate`
Create New Session
`,
  ...
  "/Users/monikabieniecka/Downloads/Physia/src/components/nav/Nav.astro",
  void 0
);
...
const $$Layout = createComponent(
  ...
  "/Users/monikabieniecka/Downloads/Physia/src/layouts/Layout.astro",
  void 0
);
