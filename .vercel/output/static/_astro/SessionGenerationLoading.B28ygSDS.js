...
import { c as b, B as j } from "./SubmitButton.DlqxO_LI.js";
import { r as o } from "./index.De2ii6Pa.js";
import "./LinkButton.DkvoeGXY.js";
import { S as v } from "./Spinner.DSa3dCc_.js";
...
async function S(s, t) {
  const r = await fetch("/api/sessions", { method: "POST", headers: y, body: JSON.stringify({ body_part_id: s, tests: t }) });
...
function _({ bodyPartId: s, tests: t }) {
...
export { _ as SessionGenerationLoading };
