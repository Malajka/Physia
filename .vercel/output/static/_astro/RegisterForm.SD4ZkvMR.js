import { j as r } from "./jsx-runtime.D3GSbgeI.js";
import { r as f, A as x, P as u } from "./PasswordField.CF_by7gb.js";
import { r as o } from "./index.De2ii6Pa.js";
import { I as h } from "./SubmitButton.DlqxO_LI.js";
import { LinkButton as m } from "./LinkButton.DkvoeGXY.js";
import { r as b } from "./auth.validator.Db2b3f6L.js";
...
const w = async (a) => {
    ...
    try {
      const e = await f({ email: t.data.email, password: t.data.password });
      return e.success
  ...
  y = () => {
    ...
    return { registrationSuccess: a, error: t, isLoading: n, submitRegistration: d, resetForm: g };
  },
  I = function ({ initialError: i = null }) {
            ...
            r.jsx("div", {
              ...
              children: r.jsxs("p", {
                ...
                children: [
                  ...
                  " ",
                  r.jsx(m, { href: "/login", variant: "text", className: "text-gray-600 underline", children: "Log in here" }),
                ],
              }),
            }),
          ],
