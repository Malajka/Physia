...
function X() {
  ...
  function P(e, t, n) {
    var o,
      ...
      s = null;
    if (t != null)
      for (o in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t)) O.call(t, o) && !g.hasOwnProperty(o) && (u[o] = t[o]);
    ...
    if (s)
      return (
        ...
        j(u)
          ...
          : u != null && (R(u) && (u = G(u, n + (!u.key || (s && s.key === u.key) ? "" : ("" + u.key).replace(I, "$&/") + "/") + e)), t.push(u)),
        1
      );
    if (((s = 0), (o = o === "" ? "." : o + ":"), j(e)))
