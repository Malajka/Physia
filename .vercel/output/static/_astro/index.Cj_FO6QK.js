...
function I(e, t, n) {
  var u,
    ...
    s = null;
  if (t != null)
    for (u in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t)) P.call(t, u) && !x.hasOwnProperty(u) && (o[u] = t[u]);
  ...
  if (s)
    return (
      ...
      k(o)
        ...
        : o != null && (E(o) && (o = J(o, n + (!o.key || (s && s.key === o.key) ? "" : ("" + o.key).replace(w, "$&/") + "/") + e)), t.push(o)),
      1
    );
  if (((s = 0), (u = u === "" ? "." : u + ":"), k(e)))
...
var l = { current: null },
  h = { transition: null },
  X = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: b };
function A() {
...
var D = $.exports;
const Y = V(D),
  Z = T({ __proto__: null, default: Y }, [D]);
export { Y as R, Z as a, D as r };
