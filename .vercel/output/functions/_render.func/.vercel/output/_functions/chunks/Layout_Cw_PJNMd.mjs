import { c as createComponent, a as createAstro, m as maybeRenderHead, b as renderComponent, r as renderTemplate, F as Fragment, d as addAttribute, n as renderHead, o as renderSlot } from './astro/server_DDqvxhIU.mjs';
import 'kleur/colors';
import { a as reactExports, R as React } from './_@astro-renderers_DziWr-Mn.mjs';
...
function ErrorAlert({ errors, render, ...props }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: !hasErrors ? { display: "none" } : void 0,
      "aria-hidden": !hasErrors,
      ...props,
      children: hasErrors && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-5 w-5 text-red-500", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            fillRule: "evenodd",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-medium text-red-800", children: [
            "Error",
            list.length > 1 ? "s" : ""
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-disc pl-5 space-y-1", children: list.map((err, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: render ? render(err) : typeof err === "string" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: err } }) : err }, i)) }) })
        ] })
      ] })
    }
  );
...
function InputFieldComponent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: id, className: "block text-sm font-medium text-gray-700 mb-1", children: [
      label,
      required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500 ml-1", "aria-hidden": "true", children: "*" })
    ] }),
    ...
    showError && /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorAlert, { errors: error })
  ] });
}
const InputField = React.memo(InputFieldComponent);
InputField.displayName = "InputField";

const baseStyles = "inline-block rounded px-2 py-2 text-center transition-colors";
const variantStyles = {
  ...
  "nav-primary": "px-2 py-2 bg-[var(--primary)] border border-[var(--primary)] text-[var(--primary-foreground)] font-bold text-lg rounded-xl shadow-md text-center hover:opacity-80",
  "nav-secondary": "bg-[var(--card)] border border-[var(--primary)] text-[var(--primary)] hover:bg-[var(--light-green)] font-bold text-lg rounded-xl shadow-md text-center hover:opacity-80",
  "nav-muted": "px-6 py-3 text-[var(--gray-text)] hover:text-[var(--primary)] hover:underline text-lg font-bold"
};
const LinkButton = React.memo(function LinkButton2({
  href,
  children,
  variant = "primary",
  className = "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, className: `${baseStyles} ${variantStyles[variant]} ${className}`, "data-testid": dataTestId, children });
});
...
const Slider = reactExports.forwardRef(
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "15px 0" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
        ...
        ` }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SliderPrimitive.Root, { ref, className: "slider-root", ...props, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SliderPrimitive.Track, { className: "slider-track", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SliderPrimitive.Range, { className: "slider-range" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Spinner({ className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("animate-spin rounded-full border-4 border-t-transparent border-primary h-8 w-8", className), ...props });
}

const SubmitButton = React.memo(function SubmitButton2({ loading = false, className, children, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", size: "lg", loading, className, ...props, children });
});
...
const LogoutButton = function LogoutButton2({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Button,
    {
      ...
      children: [
        isLoggingOut ? /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { className: "h-4 w-4" }) : null,
...
}, "/Users/monikabieniecka/Physia/src/components/nav/Nav.astro", void 0);
...
}, "/Users/monikabieniecka/Physia/src/layouts/Layout.astro", void 0);

export { $$Layout as $, Button as B, ErrorAlert as E, InputField as I, LinkButton as L, SubmitButton as S, Spinner as a, Slider as b, cn as c, jsxRuntimeExports as j };
