...
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/Layout_Cw_PJNMd.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Physia - Personalized Exercise Plans" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="min-h-screen bg-gradient-to-br from-[#b8e6d9] via-[#d4f1e8] to-[#e8f5e1]"> <div class="container mx-auto px-4 py-12"> <section class="text-center max-w-3xl mx-auto mb-16" id="about"> <div class="flex flex-col items-center mb-6"> <img src="/physia-logo.png" alt="Physia illustration" class="h-24 mb-4 md:h-32 w-auto"> <h1 class="text-4xl md:text-5xl font-bold text-[var(--primary)] text-center">
...
</p> ${!user && renderTemplate`<div class="flex flex-col sm:flex-row gap-4 justify-center items-center"> <a href="/login" class="w-fit max-w-36 sm:max-w-none sm:px-8 px-5 py-3 bg-[var(--primary)] hover:bg-dark-green text-[var(--primary-foreground)] font-medium rounded-xl shadow-md transition-colors">
Log In
...
}, "/Users/monikabieniecka/Physia/src/pages/index.astro", void 0);

const $$file = "/Users/monikabieniecka/Physia/src/pages/index.astro";
const $$url = "";
