/* empty css                                         */
import { c as createComponent, a as createAstro, b as renderComponent, r as renderTemplate } from '../../chunks/astro/server_B181Abhk.mjs';
import 'kleur/colors';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { c as cn, B as Button, a as Spinner, $ as $$Layout } from '../../chunks/Layout_DXvctC9J.mjs';
...
function useSessionGeneration(paramsOrBodyPartId, tests) {
  const { bodyPartId, tests: testsArray } = typeof paramsOrBodyPartId === "object" ? paramsOrBodyPartId : { bodyPartId: paramsOrBodyPartId, tests: tests || [] };
...
function ErrorDisplay({ error, retry }) {
  return /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "text-red-600 mb-4", children: /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-12 w-12 mx-auto", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx(
      "path",
      {
        strokeLinecap: "round",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-4 justify-center", children: [
      ...
      /* @__PURE__ */ jsx(Button, { variant: "outline", asChild: true, children: /* @__PURE__ */ jsx("a", { href: "/body-parts", children: "Go Back" }) })
    ] })
  ] });
}
function LoadingSkeleton() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl", children: [
      ...
      [1, 2, 3].map((i) => /* @__PURE__ */ jsxs("div", { className: "border rounded-lg p-4", children: [
...
function InvalidRequestDisplay() {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-6 text-center", children: [
    ...
    /* @__PURE__ */ jsx(Button, { asChild: true, children: /* @__PURE__ */ jsx("a", { href: "/body-parts", children: "← Go back to body parts selection" }) })
  ] });
}
function SessionGenerationLoading({ bodyPartId, tests }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-6", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("p", { role: "status", "aria-live": "polite", className: "text-lg text-center mb-8 max-w-md", children: statusMessage }),
      /* @__PURE__ */ jsx(LoadingSkeleton, {})
    ] }) : error ? /* @__PURE__ */ jsx(ErrorDisplay, { error, retry }) : null
  ] });
}
...
}, "/Users/monikabieniecka/Downloads/Physia/src/pages/session/generate.astro", void 0);
