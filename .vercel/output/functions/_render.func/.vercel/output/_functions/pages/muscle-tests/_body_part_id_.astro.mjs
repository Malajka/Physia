...
function MuscleTestItem({ test, value, onChange, animating }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-6 border drop-shadow-md rounded-lg bg-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6 space-y-4", children: [
      ...
      warnings.length > 0 && /* @__PURE__ */ jsx("div", { className: "bg-red-50 border-l-4 border-red-400 p-4 rounded-r", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-red-800 uppercase tracking-wide mb-2", children: "Important" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-red-700 space-y-1", children: warnings.map((warning, index) => /* @__PURE__ */ jsx("p", { children: warning }, index)) })
        ] })
      ] }) }),
      info.length > 0 && /* @__PURE__ */ jsx("div", { className: "bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-blue-800 uppercase tracking-wide mb-2", children: "What to expect" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-blue-700 space-y-1", children: info.map((infoItem, index) => /* @__PURE__ */ jsx("p", { children: infoItem }, index)) })
        ] })
      ] }) }),
      notes.length > 0 && /* @__PURE__ */ jsx("div", { className: "bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-medium text-amber-800 uppercase tracking-wide mb-2", children: "Remember" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-amber-700 space-y-1", children: notes.map((note, index) => /* @__PURE__ */ jsx("p", { children: note }, index)) })
        ] })
      ] }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col space-y-4", children: [
      /* @__PURE__ */ jsxs("label", { htmlFor: `pain-${test.id}`, className: "font-medium text-lg", children: [
        "Pain level:",
        " ",
        /* @__PURE__ */ jsx(
          "span",
...
}, "/Users/monikabieniecka/Downloads/Physia/src/components/ui/EmptyState.astro", void 0);
...
const BodyPartIdSchema = z.coerce.number({ invalid_type_error: "bodyPartId must be a number" }).int({ message: "bodyPartId must be an integer" }).positive({ message: "bodyPartId must be a positive integer" });
...
const $$bodyPartId = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/Users/monikabieniecka/Downloads/Physia/src/pages/muscle-tests/[body_part_id].astro", void 0);
