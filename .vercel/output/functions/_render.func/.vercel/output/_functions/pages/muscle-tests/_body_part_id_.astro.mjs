...
}, "/Users/monikabieniecka/Physia/src/components/ui/EmptyState.astro", void 0);

const supabaseUrl = "https://juecydaoemmuzshzkjki.supabase.co";
const supabaseAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp1ZWN5ZGFvZW1tdXpzaHpramtpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk4MTA5NTMsImV4cCI6MjA2NTM4Njk1M30.-N2yhEhXOAAlBAYka-9K6o0e5YWm7VhlMNLF01yiiH4";
const supabaseClient = createClient(supabaseUrl, supabaseAnonKey);

function capitalizeFirst(str) {
  return str.replace(/\b\w/g, (char) => char.toUpperCase());
}
async function getMuscleTestsPageData(bodyPartId) {
  const { data: muscleTests, error } = await supabaseClient.from("muscle_tests").select(
    `
      id,
      body_part_id,
      name,
...
const $$bodyPartId = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { muscleTests, fetchError, pageTitle, bodyPartId, backLink } = await getMuscleTestsPageData(Number(Astro2.params.body_part_id));
...
}, "/Users/monikabieniecka/Physia/src/pages/muscle-tests/[body_part_id].astro", void 0);

const $$file = "/Users/monikabieniecka/Physia/src/pages/muscle-tests/[body_part_id].astro";
