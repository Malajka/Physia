...
const onRequest$1 = defineMiddleware(async (context, next) => {
  const supabase = createServerClient("https://juecydaoemmuzshzkjki.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp1ZWN5ZGFvZW1tdXpzaHpramtpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk4MTA5NTMsImV4cCI6MjA2NTM4Njk1M30.-N2yhEhXOAAlBAYka-9K6o0e5YWm7VhlMNLF01yiiH4", {
    cookies: {
