...
async function getFormState({ result }) {
   ...
   */
  const actionName = searchParams.get("_astroAction") ?? /* Legacy. TODO: remove for stable */ formData.get("_astroAction")?.toString();
...
const renderers = [
  Object.assign(
    { name: "@astrojs/react", clientEntrypoint: "@astrojs/react/client.js", serverEntrypoint: "@astrojs/react/server.js" },
    { ssr: _renderer0 }
  ),
];
